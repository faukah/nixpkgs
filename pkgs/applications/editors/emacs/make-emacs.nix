{
  ...
  withNativeCompilation ? stdenv.buildPlatform.canExecute stdenv.hostPlatform && !stdenv.hostPlatform.isDarwin,
  noGui ? false,
  srcRepo ? true,
  withAcl ? false,
  withAlsaLib ? false,
...
assert withXwidgets -> !noGui && (withGTK3 || withPgtk); let
    ...
    patches =
      ...
      ++ lib.optionals withNativeCompilation [
        (
          replaceVars
          (
            if lib.versionOlder finalAttrs.version "30"
