        ...
        in
          {
            ...
            exfat-nofuse =
              if lib.versionOlder kernel.version "5.8"
              then callPackage ../os-specific/linux/exfat {}
              else null;
            ...
            iio-utils =
              if lib.versionAtLeast kernel.version "4.1"
              then callPackage ../os-specific/linux/iio-utils {}
              else null;
            ...
            opensnitch-ebpf =
              if lib.versionAtLeast kernel.version "5.10"
              then callPackage ../os-specific/linux/opensnitch-ebpf {}
              else null;

            facetimehd = callPackage ../os-specific/linux/facetimehd {};

            rust-out-of-tree-module =
              if lib.versionAtLeast kernel.version "6.7"
              then callPackage ../os-specific/linux/rust-out-of-tree-module {}
              else null;

            tuxedo-drivers =
              if lib.versionAtLeast kernel.version "4.14"
              then callPackage ../os-specific/linux/tuxedo-drivers {}
              else null;
            ...
            xone =
              ...
              then callPackage ../os-specific/linux/xone {}
              else null;
