...
in let
  ...
  in {
    ...
    CoLoR = callPackage ../development/coq-modules/CoLoR (lib.optionalAttrs (lib.versions.isEq self.coq.coq-version "8.13") {
    ...
    coqeal = callPackage ../development/coq-modules/coqeal (lib.optionalAttrs (lib.versions.range "8.13" "8.14" self.coq.coq-version) {
