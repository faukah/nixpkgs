...
with self; {
  ...
  audioop-lts =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/audioop-lts {}
    else null;
  ...
  bcrypt =
    ...
    then callPackage ../development/python-modules/bcrypt/3.nix {}
    else callPackage ../development/python-modules/bcrypt {};
  ...
  distutils =
    if pythonOlder "3.12"
    then null
    else callPackage ../development/python-modules/distutils {};
  ...
  greenlet =
    if isPyPy
    then null
    else callPackage ../development/python-modules/greenlet {};
  ...
  itk = toPythonModule (
    pkgs.itk.override {
      ...
      stdenv =
        if stdenv.cc.isGNU
        then pkgs.stdenvAdapters.useLibsFrom stdenv pkgs.gcc12Stdenv
        else stdenv;
    }
  );
  ...
  inherit
    (callPackage ../development/python-modules/mypy-boto3 {})
  ...
  standard-aifc =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-aifc {}
    else null;

  standard-chunk =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-chunk {}
    else null;

  standard-imghdr =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-imghdr {}
    else null;

  standard-mailcap =
    if pythonOlder "3.13"
    then null
    else callPackage ../development/python-modules/standard-mailcap {};

  standard-pipes =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-pipes {}
    else null;

  standard-sunau =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-sunau {}
    else null;

  standard-telnetlib =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-telnetlib {}
    else null;
