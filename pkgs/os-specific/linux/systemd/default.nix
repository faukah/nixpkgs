...
assert withBootloader -> withEfi; let
  ...
  stdenv.mkDerivation (finalAttrs: {
    ...
    passthru = {
      ...
      tests = let
        ...
        gatherNixosTestsFromCollection = prefix: collection:
        ...
        relevantNixosTests = lib.mapAttrs (
          name: value:
            assert lib.assertMsg (lib.isDerivation value) "${name} is not a derivation"; value
