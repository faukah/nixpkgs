{
  ...
  transformArgs = finalAttrs: {
    ...
    inherit
      (callPackage ./hooks {inherit dotnet-sdk dotnet-runtime;})
      dotnetConfigureHook
      dotnetBuildHook
      dotnetCheckHook
      dotnetInstallHook
  ...
  in
    ...
    // {
      ...
      versionForDotnet =
        if !(lib.hasAttr "version" args) || args.version == null
        then null
        else let
    ...
    stdenvNoCC.mkDerivation (
      finalAttrs: let
        args =
          ...
          then fnOrAttrs (args' // finalAttrs)
          else fnOrAttrs;
