...
lib.extendMkDerivation {
  ...
  extendDrvArgs = finalAttrs: {
    ...
    vendorHash ?
      throw (
        if args ? vendorSha256
        then "buildGoModule: Expect vendorHash instead of vendorSha256"
        else "buildGoModule: vendorHash is missing"
      ),
