...
in {
  simple = testers.invalidateFetcherByDrvHash fetchpatch {
    ...
    sha256 =
      if isFetchpatch2
      then "sha256-w4yU0wt64d0WkuBQPeGf8vn5TH6qSBJvNIgka9QK+/Q="
      else "sha256-PuYAqnJWAE+L9bsroOnnBGJhERW8LHrGSLtIEkKU9vg=";
  };
  ...
  relative = testers.invalidateFetcherByDrvHash fetchpatch {
    ...
    sha256 =
      if isFetchpatch2
      then "sha256-1TtmuKeNIl/Yp+sfzBMR8Ue78tPIgjqGgjasa5IN52o="
      else "sha256-KlmIbixcds6GyKYt1fx5BxDIrU7msrgDdYo9Va/KJR4=";
  };
  ...
  full = testers.invalidateFetcherByDrvHash fetchpatch {
    ...
    sha256 =
      if isFetchpatch2
      then "sha256-+UKmEbr2rIAweCav/hR/7d4ZrYV84ht/domTrHtm8sM="
      else "sha256-+UKmEbr2rIAweCav/hR/7d4ZrYV84ht/domTrHtm8sM=";
  };
  ...
  decode = testers.invalidateFetcherByDrvHash fetchpatch {
    ...
    sha256 =
      if isFetchpatch2
      then "sha256-oMvPlmzE51ArI+EvFxONXkqmNee39106/O1ikG0Bdso="
      else "sha256-SJHk8XrutqAyoIdORlhCpBCN626P+uzed7mjKz5eQYY=";
  };
  ...
  fileWithSpace = testers.invalidateFetcherByDrvHash fetchpatch {
    ...
    sha256 =
      if isFetchpatch2
      then "sha256-RB6pjigoXtzHILkGFXYd3Lz2aM9DvO0NRmLdey1N6gg="
      else "sha256-aptUvVojqIIIVNuHqkl+C+dZBGFfs+1MUd0FNV+4j4E=";
  };
