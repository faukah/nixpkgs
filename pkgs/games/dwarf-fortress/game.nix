{
  ...
  game =
    if hasAttr dfVersion dfVersions.game.versions
    then (getAttr dfVersion dfVersions.game.versions).df
  ...
  url =
    if hasAttr dfPlatform game.urls
    then getAttr dfPlatform game.urls
