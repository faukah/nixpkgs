...
stdenv.mkDerivation rec {
  ...
  bloop-binary = fetchurl {
    ...
    sha256 =
      if stdenv.hostPlatform.isLinux && stdenv.hostPlatform.isx86_64
      then "sha256-GoWHVYIA98YMMmhYj1bBysABBq2UxEcELXqDi+XRnQ4="
      else if stdenv.hostPlatform.isDarwin && stdenv.hostPlatform.isx86_64
      then "sha256-hE54Z2QLlAt4S+LQOAD0jLf1y2/PkKO9JAT2L6M8lWA="
      else if stdenv.hostPlatform.isDarwin && stdenv.hostPlatform.isAarch64
      then "sha256-8gtaiSilf1yL50QSsy4K686R1J9W5NL1JyB7onMSTOw="
      else throw "unsupported platform";
  };
