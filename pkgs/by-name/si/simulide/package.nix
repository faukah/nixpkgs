...
in let
  ...
  iconPath =
    if lib.versionOlder versionNum "1.0.0"
    then "resources/icons/hicolor/256x256/simulide.png" # upstream had a messed up icon path in this release
    else "resources/icons/simulide.png";
  ...
  stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      ${
        ...
        ''
        else if lib.versionOlder versionNum "1.0.0"
        then ''
