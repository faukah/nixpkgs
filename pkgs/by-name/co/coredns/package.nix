      ...
      ${
        (lib.concatMapStringsSep "\n" (
            ...
            in
              ...
              then "echo '${formatPlugin plugin}' >> plugin.cfg"
              else if position == "start-of-file"
              then "sed -i '1i ${formatPlugin plugin}' plugin.cfg"
              else if lib.hasAttrByPath ["before"] position
              then ''
              ...
              ''
              else if lib.hasAttrByPath ["after"] position
              then ''
