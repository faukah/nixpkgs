...
# Do not edit!
{
  ...
  components = {
    ...
    "analytics_insights" = ps:
      with ps; [
        python-homeassistant-analytics
      ];
    "android_ip_webcam" = ps:
      with ps; [
        pydroid-ipcam
      ];
    "androidtv" = ps:
    ...
    "cisco_mobility_express" = ps:
      with ps; [
        ciscomobilityexpress
      ];
    "cisco_webex_teams" = ps:
      with ps; [
        webexpythonsdk
      ];
    "citybikes" = ps:
    ...
    "device_automation" = ps:
      with ps; [
      ];
    "device_sun_light_trigger" = ps:
      with ps; [
        pillow
      ];
    "device_tracker" = ps:
    ...
    "devolo_home_control" = ps:
      with ps; [
        devolo-home-control-api
        ifaddr
        zeroconf
      ];
    "devolo_home_network" = ps:
      with ps; [
        devolo-plc-api
        ifaddr
        zeroconf
    ...
    "entur_public_transport" = ps:
      with ps; [
        enturclient
      ];
    "environment_canada" = ps:
      with ps; [
        env-canada
      ];
    "envisalink" = ps:
    ...
    "garages_amsterdam" = ps:
      with ps; [
        odp-amsterdam
      ];
    "gardena_bluetooth" = ps:
      with ps; [
        aioesphomeapi
        aiohasupervisor
        aioruuvigateway
    ...
    "generic_hygrostat" = ps:
      with ps; [
      ];
    "generic_thermostat" = ps:
      with ps; [
        fnv-hash-fast
        psutil-home-assistant
        sqlalchemy
    ...
    "google_generative_ai_conversation" = ps:
      with ps; [
        google-genai
        ha-ffmpeg
        hassil
    ...
    "home_plus_control" = ps:
      with ps; [
      ];
    "homeassistant" = ps:
      with ps; [
      ];
    "homeassistant_alerts" = ps:
      with ps; [
        aiohasupervisor
      ];
    "homeassistant_green" = ps:
      with ps; [
        aiohasupervisor
    ...
    "homeassistant_hardware" = ps:
      with ps; [
        aiohasupervisor
        ha-silabs-firmware-client
        universal-silabs-flasher
      ];
    "homeassistant_sky_connect" = ps:
      with ps; [
        aiohasupervisor
        aiousbwatcher
        ha-silabs-firmware-client
    ...
    "hunterdouglas_powerview" = ps:
      with ps; [
        aiopvapi
      ];
    "hurrican_shutters_wholesale" = ps:
      with ps; [
      ];
    "husqvarna_automower" = ps:
      with ps; [
        aioautomower
      ];
    "husqvarna_automower_ble" = ps:
      with ps; [
        aioesphomeapi
        aiohasupervisor
        aioruuvigateway
    ...
    "microsoft_face_detect" = ps:
      with ps; [
        pyturbojpeg
      ];
    "microsoft_face_identify" = ps:
      with ps; [
        pyturbojpeg
      ];
    "miele" = ps:
    ...
    "nsw_rural_fire_service_feed" = ps:
      with ps; [
    ...
    "swiss_hydrological_data" = ps:
      with ps; [
        swisshydrodata
      ];
    "swiss_public_transport" = ps:
      with ps; [
    ...
    "trafikverket_camera" = ps:
      with ps; [
        pytrafikverket
      ];
    "trafikverket_ferry" = ps:
      with ps; [
        pytrafikverket
      ];
    "trafikverket_train" = ps:
      with ps; [
        pytrafikverket
      ];
    "trafikverket_weatherstation" = ps:
      with ps; [
        pytrafikverket
      ];
    "transmission" = ps:
