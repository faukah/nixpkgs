  ...
  finalAttrs:
    {
      ...
      patches =
        ...
        ++ lib.optional (lib.versionOlder release_version "17") (
          if lib.versionAtLeast release_version "14"
          then
            fetchpatch {
          ...
          else ./ignore-nostd-link-13.diff
        )
        ...
        ++ [
          (
            replaceVars
            (
              if (lib.versionOlder release_version "16")
              then ./clang-11-15-LLVMgold-path.patch
              else ./clang-at-least-16-LLVMgold-path.patch
            )
            {
      ...
      postInstall =
        ...
        ''
        + (
          if lib.versionOlder release_version "15"
          then ''
        ...
        + (
          ...
          ''
          else if lib.versionOlder release_version "20"
          then ''
