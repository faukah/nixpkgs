...
callPackage ./common.nix (
  {
    ...
    dists = {
      x86_64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-HEQ0lxHsoyHG+ZWIlWsbkqMf/rauARafzWoiElRwekA="
      ...
      aarch64-linux = {
        ...
        hash =
          if enableJavaFX
          then throw "JavaFX is not available for aarch64-linux"
      ...
      x86_64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-1/YmLWA/men8jMjnhkZVMf2irf6Tc/5x7UECxqKJcL4="
      ...
      aarch64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-TumPJoHmvklMlcpF4PFY/Arcdc5fkX5z0xeIuNFxluQ="
