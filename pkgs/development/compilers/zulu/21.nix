...
callPackage ./common.nix (
  {
    ...
    dists = {
      x86_64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-Q2bdM0/a2t5aBRCIzXBlhXamf8N7wdSUsK5VhaU9DcY="
      ...
      aarch64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-BzNEcDrQo5yOWnEsJxw9JfXYdZGN6/wxnTDB0qC1i/0="
      ...
      x86_64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-H3gM2XCCcuUxlAEzX6IO7Cp6NtH85PYHlH54k5XvNAc="
      ...
      aarch64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-lLAb8MABo95A5WcayBLNvsBSdVFptnO4EmhX2gjo6r8="
