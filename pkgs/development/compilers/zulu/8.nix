...
callPackage ./common.nix (
  {
    ...
    dists = {
      x86_64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-Ls2sHCtP9htBIDwq5fNDRA3/bGN0bzaMp6nNkjU1zx8="
      ...
      aarch64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-aVBleFrj4OpUJh82rM8XQGy9SzGqjaeOBo20nAbtpJo="
      ...
      x86_64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-7NB0OH194nZdpIGyX8gLxJzjJdi2UIxmGsGI5M0yqJ4="
      ...
      aarch64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-JuQkY923tizx5HQo4WC3YCk75a4qHJYNRFKpZ8XES58="
