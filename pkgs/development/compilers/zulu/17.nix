...
callPackage ./common.nix (
  {
    ...
    dists = {
      x86_64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-qKpkvk7/IEnlOJoy7An0AVGUXWkWeuuiQzqKKE/+Ec4="
      ...
      aarch64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-mpTM/43oyDsOnoZM8AW1Z7EFTznnPAnYoC+T6csc8Fw="
      ...
      x86_64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-jb1oPmRzlYUMONovdsHowlC44X3/PFZ8KilxSsR924U="
      ...
      aarch64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-rEILTKTpX8DEoOGhlrhbxpcCyF2+QrjW92h0ox9ezp0="
