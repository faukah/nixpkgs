...
callPackage ./common.nix (
  {
    ...
    dists = {
      x86_64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-eP2BCD77uRmukd48+pDlIlhos9RjL9VYx8tpQdq2uNo="
      ...
      aarch64-linux = {
        ...
        hash =
          if enableJavaFX
          then "sha256-nAUjPk9gktO0UJk7gAKygq+ztSJY5wk+EoG1LgJidJ8="
      ...
      x86_64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-hanQw2FWbqsmGR1WixbM0BNWGeXmS2vt9tbaaEY7D1c="
      ...
      aarch64-darwin = {
        ...
        hash =
          if enableJavaFX
          then "sha256-WbzpfPgoT3CTazKBnI1Fg+q+YQP6MwCWkon6VOeLZsA="
