{
  ...
  deploymentVersion =
    if lib.versionOlder (targetPlatform.darwinMinVersion or "0") "10.15"
    then "10.15"
    else targetPlatform.darwinMinVersion;
  ...
  swiftInstallComponents = [
    ...
    (
      ...
      then "sourcekit-xpc-service"
      else "sourcekit-inproc"
    )
    "swift-remote-mirror"
