{
  ...
  expandSingleDep = dep: lib.optionals (lib.isDerivation dep) ([dep] ++ map (output: dep.${output}) dep.outputs);
  ...
  dartPath = "${
    if (lib.versionAtLeast flutterVersion "3.23")
    then "flutter/third_party"
    else "third_party"
  }/dart";
in
