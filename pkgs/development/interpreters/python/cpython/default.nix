    ...
    stdenv.mkDerivation (finalAttrs: {
      ...
      patches =
        ...
        ++ optionals (hasDistutilsCxxPatch && pythonOlder "3.12") [
          ...
          (
            if pythonAtLeast "3.7" && pythonOlder "3.11"
            then ./3.7/python-3.x-distutils-C++.patch
            else if pythonAtLeast "3.11"
            then ./3.11/python-3.x-distutils-C++.patch
            else
              fetchpatch {
        ...
        ++ optionals (stdenv.hostPlatform.isMinGW) (
          ...
          in (builtins.map (f: "${mingw-patch}/${f}") [
      ...
      meta = with lib; {
        ...
        in
          if sourceVersion.suffix == ""
          then "https://docs.python.org/release/${version}/whatsnew/changelog.html"
          else "https://docs.python.org/${majorMinor}/whatsnew/changelog.html#python-${dashedVersion}";
