...
in
  {
    ...
    #   };
    # }
    overrideRequireX = packageNames: old: let
      nameValuePairs =
        map (name: {
          inherit name;
    ...
    #   });
    # }
    overrideRequireHome = packageNames: old: let
      nameValuePairs =
        map (name: {
          inherit name;
    ...
    #   };
    # }
    overrideSkipCheck = packageNames: old: let
      nameValuePairs =
        map (name: {
          inherit name;
          value = (builtins.getAttr name old).override {
    ...
    #   };
    # }
    overrideBroken = packageNames: old: let
      nameValuePairs =
        map (name: {
          inherit name;
          value = (builtins.getAttr name old).override {
    ...
    mkPackageSet = derive: packagesJSON:
      lib.mapAttrs (
        k: v:
