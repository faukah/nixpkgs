...
in
  (backendStdenv.mkDerivation (finalAttrs: {
    ...
    brokenConditions = {
      ...
      "lib output follows static output" = let
    ...
    meta = {
      ...
      license =
        ...
        then
          ...
          let
            licensePath =
              if redistribRelease.license_path != null
              then redistribRelease.license_path
