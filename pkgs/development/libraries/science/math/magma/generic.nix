...
# }
{
  ...
  effectiveRocmPackages =
    if strings.versionOlder version "2.8.0"
    then
      throw ''
  ...
  gpuTargetString = strings.concatStringsSep "," (
    ...
    then gpuArchWarner supportedRocmArches unsupportedRocmArches
    else if cudaSupport
    then [] # It's important we pass explicit -DGPU_TARGET to reset magma's defaults
