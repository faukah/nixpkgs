    ...
    self: super:
      builtins.intersectAttrs super {
        ...
        inherit
          (
            let
              installHledgerExtraFiles = manpagePathPrefix:
                overrideCabal (drv: {
                  buildTools =
                    drv.buildTools or []
                    ++ [
        ...
        gtk = lib.pipe super.gtk (
          ...
          ++ (
            ...
            then [(appendConfigureFlag "-fhave-quartz-gtk")]
            else []
          )
        );
        ...
        servant-client-core =
          if (pkgs.lib.getVersion super.servant-client-core) == "0.16"
          then appendPatch ./patches/servant-client-core-redact-auth-header.patch super.servant-client-core
          else super.servant-client-core;
