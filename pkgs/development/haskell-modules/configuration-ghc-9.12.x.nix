{
  ...
  warnVersion = predicate: ver: pkg: let
    pname = pkg.pname;
  in
    lib.warnIf (
      predicate ver
      super.${pname}.version
    ) "override for haskell.packages.ghc912.${pname} may no longer be needed"
    pkg;
...
in
  with haskellLib; {
    ...
    terminfo =
      ...
      then null
      else haskellLib.doDistribute self.terminfo_0_4_1_7;
    text = null;
    time = null;
    transformers = null;
    unix = null;
    ...
    interpolate = assert super.ghc.version == "9.12.2";
