    ...
    self: super:
      {
        ...
        accelerate = assert super.accelerate.version == "1.3.0.0";
        ...
        basement =
          appendPatches (lib.optionals pkgs.stdenv.hostPlatform.is32bit [
            (fetchpatch {
        ...
        Lazy-Pbkdf2 =
          ...
          then dontCheck super.Lazy-Pbkdf2
          else super.Lazy-Pbkdf2;
        ...
        unix-time =
          ...
          then dontCheck super.unix-time
          else super.unix-time;
        ...
        hslua-core =
          if pkgs.stdenv.hostPlatform.isMusl
          then dontCheck super.hslua-core
          else super.hslua-core;
        ...
        cryptohash-sha256 =
          if pkgs.stdenv.hostPlatform.is32bit
          then dontCheck super.cryptohash-sha256
          else super.cryptohash-sha256;
        ...
        hw-int = assert super.hw-int.version == "0.0.2.0";
          doJailbreak super.hw-int;

        # 2025-04-09: jailbreak to allow tasty-quickcheck >= 0.11
        chimera = assert super.chimera.version == "0.4.1.0";
          doJailbreak super.chimera;

        # 2025-04-09: jailbreak to allow tasty-quickcheck >= 0.11
        bzlib = assert super.bzlib.version == "0.5.2.0";
        ...
        egison-pattern-src-th-mode = assert super.egison-pattern-src-th-mode.version == "0.2.1.2";
          doJailbreak super.egison-pattern-src-th-mode;

        # 2025-04-09: jailbreak to allow base >= 4.17, hasql >= 1.6, hasql-transaction-io >= 0.2
        hasql-streams-core = assert super.hasql-streams-core.version == "0.1.0.0";
          doJailbreak super.hasql-streams-core;

        # 2025-04-09: jailbreak to allow bytestring >= 0.12, text >= 2.1
        pipes-text = assert super.pipes-text.version == "1.0.1";
          doJailbreak super.pipes-text;

        # 2025-04-09: jailbreak to allow bytestring >= 0.12
        array-builder = assert super.array-builder.version == "0.1.4.1";
        ...
        brillo-rendering =
          ...
          ) "haskellPackages.brillo-rendering override can be dropped"
          doJailbreak
          super.brillo-rendering;
        brillo-examples =
          lib.warnIf (
            super.brillo-examples.version != "1.13.3"
          ) "haskellPackages.brillo-examples override can be dropped"
          doJailbreak
          super.brillo-examples;
        brillo-juicy =
          lib.warnIf (
            super.brillo-juicy.version != "0.2.4"
          ) "haskellPackages.brillo-juicy override can be dropped"
          doJailbreak
          super.brillo-juicy;
        brillo =
          lib.warnIf (
            super.brillo.version != "1.13.3"
          ) "haskellPackages.brillo override can be dropped"
          doJailbreak
          super.brillo;

        # 2025-04-13: jailbreak to allow th-abstraction >= 0.7
        crucible = assert super.crucible.version == "0.7.2";
          doJailbreak (
        ...
        ktx-codec = assert super.ktx-codec.version == "0.0.2.1";
        ...
        sr-extra =
          overrideCabal (drv: {
            version = assert super.sr-extra.version == "1.88"; "1.88-unstable-2025-03-30";
      ...
      // (
        ...
        in
          {
            gogol-core = assert super.gogol-core.version == "0.5.0";
            ...
            gogol = assert super.gogol.version == "0.5.0";
      ...
      // (
        ...
        in
          amazonkaServiceOverrides
          // {
            amazonka-core = assert super.amazonka-core.version == "2.0";
            ...
            amazonka = assert super.amazonka.version == "2.0";
