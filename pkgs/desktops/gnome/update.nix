{
  ...
  in
    if builtins.isBool freeze
    then lib.optionals (freeze && minorAvailable) [upperBound]
    else if builtins.isString freeze
    then [freeze]
    else throw "“freeze” argument needs to be either a boolean, or a version string.";
