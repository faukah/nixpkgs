...
# Almost directly vendored from https://github.com/NixOS/ofborg/blob/5a4e743f192fb151915fcbe8789922fa401ecf48/ofborg/src/maintainers.nix
{
  ...
  anyMatchingFile = filename: builtins.any (changed: lib.strings.hasSuffix changed filename) changedpaths;
          ...
          (
            ...
            in
              ...
              then
                if value != null
                then true
                else builtins.trace "${pkg.name} exists but is null" false
  ...
  relevantFilenames = drv: (lib.lists.unique (
