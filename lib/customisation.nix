...
in rec {
  ...
  */
  callPackageWith = autoArgs: fn: args: let
    ...
    prettySuggestions = suggestions:
      ...
      then ", did you mean ${elemAt suggestions 0}?"
    ...
    errorForArg = arg: let
      ...
      loc' =
        ...
        then toString fn + optionalString (pathIsDirectory fn) "/default.nix"
  ...
  ```
  */
  callPackagesWith = autoArgs: fn: args: let
    f =
      if isFunction fn
      then fn
      else import fn;
  ...
  */
  makeScopeWithSplicing' = {
    ...
    self =
      ...
      // {
        ...
        # overridden.
        overrideScope = g: (makeScopeWithSplicing' {inherit splicePackages newScope;} {
  ...
  :::
  */
  extendMkDerivation = let
    extendsWithExclusion = excludedNames: g: f: final: let
      previous = f final;
    in
