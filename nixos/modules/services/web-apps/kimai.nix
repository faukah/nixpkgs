  ...
  config = mkIf (eachSite != {}) (mkMerge [
    {
      ...
      services.phpfpm.pools =
        mapAttrs' (
          hostName: cfg: (nameValuePair "kimai-${hostName}" {
...

    {
      ...
      systemd.services = mkMerge [
        (mapAttrs' (
            hostName: cfg: (nameValuePair "kimai-init-${hostName}" {
              ...
              in ''
                ...
                serverVersion=${
                  ...
                  then cfg.database.serverVersion
                  else
        ...
        (mapAttrs' (
            hostName: cfg: (nameValuePair "phpfpm-kimai-${hostName}" {
              serviceConfig = {
                EnvironmentFile = [cfg.environmentFile];
              };
            })
