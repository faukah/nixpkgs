    ...
    settings = mkOption {
      type = types.submodule {
        ...
        options = {
          ...
          "profile.enabled" =
            mkEnableOption "global profiles"
            // {
              description = ''
        ...
        mkDefault (
          ...
          then
            throw ''
              ...
              `pkgs.nextcloud`.
            ''
          else if versionOlder stateVersion "24.05"
          then nextcloud27
          else if versionOlder stateVersion "24.11"
          then nextcloud29
          else if versionOlder stateVersion "25.05"
          then nextcloud30
          else nextcloud31
        );
