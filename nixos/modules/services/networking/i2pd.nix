  ...
  options = {
    services.i2pd = {
      ...
      precomputation.elgamal =
        mkEnableTrueOption "Precomputed ElGamal tables"
        // {
          description = ''
      ...
      proto.http =
        (mkEndpointOpt "http" "127.0.0.1" 7070)
        // {
