      ...
      Subnet = mkDefault (
        map (
          subnet:
            ...
            then "${subnet.address}#${toString subnet.weight}"
            ...
            in {
              ...
              preStart = ''
                ...
                ${
                  ...
                  then "  # ed25519 Keyfile managed by nix"
                  else ''
                ...
                ${
                  if data.rsaPrivateKeyFile != null
                  then "  # RSA Keyfile managed by nix"
                  else ''
