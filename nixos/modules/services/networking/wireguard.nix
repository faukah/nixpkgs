...
with lib; let
  ...
  peerUnitServiceName = interfaceName: peerName: dynamicRefreshEnabled: let
    refreshSuffix = optionalString dynamicRefreshEnabled "-refresh";
  in "wireguard-${interfaceName}-peer-${peerName}${refreshSuffix}";
    ...
    nameValuePair serviceName {
      ...
      serviceConfig =
        ...
        then {
          ...
          Restart = "always";
          RestartSec =
            if null != peer.dynamicEndpointRefreshRestartSeconds
  ...
  generateInterfaceTarget = name: values: let
